...
#define M_APPLY_FUNC2B(func, arg1, arg2) M_IF(M_EMPTY_P(arg2))(, func(arg1, arg2))
#define M_MAP2B_0(                                                                                 \
    func, data, a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s, t, u, v, w, x, y, z, ...) \
    M_APPLY_FUNC2B(func, data, a)                                                                  \
    M_APPLY_FUNC2B(func, data, b) M_APPLY_FUNC2B(func, data, c) M_APPLY_FUNC2B(func, data, d)      \
        M_APPLY_FUNC2B(func, data, e) M_APPLY_FUNC2B(func, data, f) M_APPLY_FUNC2B(func, data, g)  \
            M_APPLY_FUNC2B(func, data, h) M_APPLY_FUNC2B(func, data, i)                            \
                M_APPLY_FUNC2B(func, data, j) M_APPLY_FUNC2B(func, data, k)                        \
                    M_APPLY_FUNC2B(func, data, l) M_APPLY_FUNC2B(func, data, m)                    \
                        M_APPLY_FUNC2B(func, data, n) M_APPLY_FUNC2B(func, data, o)                \
                            M_APPLY_FUNC2B(func, data, p) M_APPLY_FUNC2B(func, data, q)            \
                                M_APPLY_FUNC2B(func, data, r) M_APPLY_FUNC2B(func, data, s)        \
                                    M_APPLY_FUNC2B(func, data, t) M_APPLY_FUNC2B(func, data, u)    \
                                        M_APPLY_FUNC2B(func, data, v)                              \
...
#define M_TEST_METHOD_P(method, oplist) M_BOOL(M_GET_METHOD(method, 0, M_FLAT oplist))
...
X92 M_IF(KO)
X93 M_GET_METHOD(INIT, 0, INIT(KO)) X94 M_GET_METHOD(INIT, 0, M_FLAT(INIT(KO))) X95
...
X2 TEST2((INIT(ok)))     // ==> expect 1, get 1
    ...
    X5 TEST4(INIT(KO)) X6
    TEST3((INIT(KO))) // ==> expect ok, get "error: macro 'KO' used with too many args"
