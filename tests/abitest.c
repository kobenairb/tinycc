...
{
    const char *src = "typedef struct ret_2float_test_type_s {float x, y;} ret_2float_test_type;"
...
{
    const char *src = "typedef struct ret_2double_test_type_s {double x, y;} ret_2double_test_type;"
...
typedef ret_2double_test_type (*ret_8plus2double_test_function_type)(
    double, double, double, double, double, double, double, ret_2double_test_type, double, double);
...
{
    const char *src = "typedef struct ret_2double_test_type_s {double x, y;} ret_2double_test_type;"
                      "ret_2double_test_type f(double x1, double x2, double x3, double x4, double "
                      "x5, double x6, double x7, ret_2double_test_type a, double x8, double x9) {\n"
...
{
    const char *src = "typedef struct ret_mixed3_test_type_s {float x; int y; float x2; int y2;} "
                      "ret_mixed3_test_type;"
...
{
    const char *src = "typedef struct reg_pack_test_type_s {int x, y;} reg_pack_test_type;"
...
{
    const char *src = "typedef struct reg_pack_longlong_test_type_s {long long x, y;} "
                      "reg_pack_longlong_test_type;"
...
static int ret_6plus2longlong_test(void)
{
    const char *src
        = "typedef struct reg_pack_longlong_test_type_s {long long x, y;} "
          "reg_pack_longlong_test_type;"
          "reg_pack_longlong_test_type f(long long x1, long long x2, long long x3, long long x4, "
          "long long x5, reg_pack_longlong_test_type a, long long x8, long long x9) {\n"
...
{
    const char *src = "typedef struct sret_test_type_s {long long a, b, c;} sret_test_type;\n"
...
{
    const char *src = "typedef union two_member_union_test_type_u {int x; long y;} "
                      "two_member_union_test_type;\n"
...
typedef many_struct_test_type (*many_struct_test_function_type)(many_struct_test_type,
                                                                many_struct_test_type,
                                                                many_struct_test_type,
                                                                many_struct_test_type,
                                                                many_struct_test_type,
...
static int many_struct_test(void)
{
    const char *src
        = "typedef struct many_struct_test_type_s {long long a, b, c;} many_struct_test_type;\n"
          "many_struct_test_type f(many_struct_test_type x1, many_struct_test_type x2, "
          "many_struct_test_type x3, many_struct_test_type x4, many_struct_test_type x5, "
          "many_struct_test_type x6) {\n"
...
typedef many_struct_test_2_type (*many_struct_test_2_function_type)(many_struct_test_2_type,
                                                                    many_struct_test_2_type,
                                                                    many_struct_test_2_type,
                                                                    many_struct_test_2_type,
                                                                    many_struct_test_2_type,
...
static int many_struct_test_2(void)
{
    const char *src
        = "typedef struct many_struct_test_2_type_s {int a, b;} many_struct_test_2_type;\n"
          "many_struct_test_2_type f(many_struct_test_2_type x1, many_struct_test_2_type x2, "
          "many_struct_test_2_type x3, many_struct_test_2_type x4, many_struct_test_2_type x5, "
...
typedef many_struct_test_3_type (*many_struct_test_3_function_type)(many_struct_test_3_type,
                                                                    many_struct_test_3_type,
                                                                    many_struct_test_3_type,
                                                                    many_struct_test_3_type,
                                                                    many_struct_test_3_type,
...
static int many_struct_test_3(void)
{
    const char *src
        = "typedef struct many_struct_test_3_type_s {int a, b;} many_struct_test_3_type;\n"
          "many_struct_test_3_type f(many_struct_test_3_type x1, many_struct_test_3_type x2, "
          "many_struct_test_3_type x3, many_struct_test_3_type x4, many_struct_test_3_type x5, "
...
{
    const char *src = "#include <stdarg.h>\n"
...
typedef void (*stdarg_many_test_function_type)(
    int, int, int, int, int, stdarg_many_test_struct_type, int, int, ...);
...
static int stdarg_many_test(void)
{
    const char *src = "#include <stdarg.h>\n"
                      ...
                      "void f (int a, int b, int c, int d, int e, stdarg_many_test_struct_type l, "
                      "int f, int g, ...){\n"
                      "  va_list ap;\n"
                      "  int *p;\n"
                      "  va_start (ap, g);\n"
...
{
    const char *src = "long double f(long double a, int b, long double c, int d, long double e) {\n"
                      "  return a + c + e;\n"
                      "}\n";
