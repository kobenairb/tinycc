...
const static struct complexinit cix[] = {
    [0] = {.a = 2000, .b = (const struct complexinit0[]){{2001, 2002}, {2003, 2003}, {}}}};
...
void manyarg_test(void)
{
    ...
    printf("%d %d %d %d %d %d %d %d %f %f %f %f %f %f %f %f %f %f\n",
           ...
           8.9,
           9.0);
    printf("%d %d %d %d %d %d %d %d %f %f %f %f %f %f %f %f %f %f " LONG_LONG_FORMAT
           ...
           42.0,
           43.0);
    printf("%Lf %d %d %d %d %d %d %d %d %f %f %f %f %f %f %f %f %f %f " LONG_LONG_FORMAT
           " " LONG_LONG_FORMAT " %f %f\n",
           ld,
           1,
           2,
...
void stdarg_test(void)
{
    ...
    vprintf1("%F %F %F\n",
             LONG_DOUBLE_LITERAL(1.2),
             LONG_DOUBLE_LITERAL(2.3),
             LONG_DOUBLE_LITERAL(3.4));
    vprintf1("%d %f %l %F %d %f %l %F\n",
             1,
             1.2,
             3LL,
             LONG_DOUBLE_LITERAL(4.5),
             6,
             7.8,
             9LL,
             LONG_DOUBLE_LITERAL(0.1));
...
#define tps(str)                              \
    ...
    printf("stmtexpr: %s %s\n", tps("somerandomlongstring"), tps("anotherlongstring"));
...
unsigned long mconstraint_test(struct struct1231 *r)
{
    ...
    a[0] = 0;
    __asm__ volatile(
        "lea %2,%0; movl 4(%0),%k0; addl %2,%k0; movl $51,%2; movl $52,4%2; movl $63,%1"
        : "=&r"(ret), "=m"(a)
