...
#define TCC_TARGET_I386
    ...
    && !defined(TCC_TARGET_C67) && !defined(CONFIG_USE_LIBGCC) && !defined(TCC_MUSL)
#define CONFIG_TCC_BCHECK /* enable bound checking code */
#endif

/* define it to include assembler support */
#if !defined(TCC_TARGET_ARM) && !defined(TCC_TARGET_ARM64) && !defined(TCC_TARGET_C67)
...
#define CONFIG_TCC_SYSINCLUDEPATHS                                                        \
    "{B}/include"                                                                         \
    ":" ALSO_TRIPLET(CONFIG_SYSROOT "/usr/local/include") ":" ALSO_TRIPLET(CONFIG_SYSROOT \
                                                                           "/usr/include")
#endif
#endif
...
#define CONFIG_TCC_LIBPATHS                                                           \
    ...
    ":" ALSO_TRIPLET(CONFIG_SYSROOT "/" CONFIG_LDDIR) ":" ALSO_TRIPLET(CONFIG_SYSROOT \
...
struct Attribute
{
    unsigned func_call : 3, /* calling convention (0..5), see below */
        ...
        packed : 1, func_export : 1, func_import : 1, func_args : 5, func_body : 1, mode : 4,
...
#define VT_VIS_SHIFT \
    19                /* shift for symbol visibility, overlapping
...
#define VT_STORAGE \
    (VT_EXTERN | VT_STATIC | VT_TYPEDEF | VT_INLINE | VT_IMPORT | VT_EXPORT | VT_WEAK | VT_VIS_MASK)
...
ST_FUNC void put_stabs_r(const char *str,
                         int type,
                         int other,
                         int desc,
                         unsigned long value,
...
ST_FUNC void relocate(
    TCCState *s1, ElfW_Rel *rel, int type, unsigned char *ptr, addr_t addr, addr_t val);
