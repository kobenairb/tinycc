...
#define CONFIG_TCC_LIBPATHS                                                                       \
    CONFIG_SYSROOT "/usr/" CONFIG_LDDIR "/" CONFIG_MULTIARCHDIR ":" CONFIG_SYSROOT                \
                   "/usr/" CONFIG_LDDIR ":" CONFIG_SYSROOT "/" CONFIG_LDDIR                       \
                   "/" CONFIG_MULTIARCHDIR ":" CONFIG_SYSROOT "/" CONFIG_LDDIR ":" CONFIG_SYSROOT \
                   "/usr/local/" CONFIG_LDDIR "/" CONFIG_MULTIARCHDIR ":" CONFIG_SYSROOT          \
...
typedef struct AttributeDef
{
    unsigned func_call : 3, /* calling convention (0..5), see below */
        ...
        packed : 1, func_export : 1, func_import : 1, func_args : 5, mode : 4, weak : 1, fill : 11;
...
#define VLA_SCOPE_FLAGS                \
    (VLA_SP_SAVED | VLA_NEED_NEW_FRAME \
     | VLA_IN_SCOPE) /* Flags which are saved and restored upon entering and exiting a block */
...
#define VT_STORAGE \
    (VT_EXTERN | VT_STATIC | VT_TYPEDEF | VT_INLINE | VT_IMPORT | VT_EXPORT | VT_WEAK)
